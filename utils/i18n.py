...
MESSAGES: dict[str, dict[str, str]] = {
    "ru": {
        ...
        "settings_ui_saved": "Язык интерфейса: {lang} ✅",
    ...
    "en": {
        ...
        "settings_ui_saved": "Interface language: {lang} ✅",
    ...
    "de": {
        ...
        "settings_ui_saved": "Oberflächensprache: {lang} ✅",
    ...
    "it": {
        ...
        "settings_ui_saved": "Lingua interfaccia: {lang} ✅",
